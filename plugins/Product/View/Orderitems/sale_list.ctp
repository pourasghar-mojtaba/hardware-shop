	...
	<div class="content">
        ...
        <div class="midContent">
        	<div class="col-md-3">
				...
				<?php echo $this->element('Users/setting_menu',array('active'=>'sale_list')); ?>
														...
														<select size="1" aria-controls="DataTables_Table_0" onchange="if (this.value) window.location.href=this.value" class="selectOption myFormComponent">
															<?php
																if(isset($_REQUEST['filter']) && $_REQUEST['filter']==10)
																	echo "<option value='". __SITE_URL."orderitems/sale_list?filter=10 ' selected='selected'>10</option>";
																	else echo"<option value='". __SITE_URL."orderitems/sale_list?filter=10 '>10</option>";
																if(isset($_REQUEST['filter']) && $_REQUEST['filter']==25)
																	echo "<option value='". __SITE_URL."orderitems/sale_list?filter=25 ' selected='selected'>25</option>";
																	else echo"<option value='". __SITE_URL."orderitems/sale_list?filter=25 '>25</option>";	
																if(isset($_REQUEST['filter']) && $_REQUEST['filter']==50)
																	echo "<option value='". __SITE_URL."orderitems/sale_list?filter=50 ' selected='selected'>50</option>";
																	else echo"<option value='". __SITE_URL."orderitems/sale_list?filter=50 '>50</option>";	
																if(isset($_REQUEST['filter']) && $_REQUEST['filter']==100)
																	echo "<option value='". __SITE_URL."orderitems/sale_list?filter=100 ' selected='selected'>100</option>";
																	else echo"<option value='". __SITE_URL."orderitems/sale_list?filter=100 '>100</option>";			
															?>
														</select> 
														</label>
													</div>
									...
									<table class="myTable aboutDr cell_center" id="datatable-1">
										<thead>
											<tr>
											  ...
											  <th><?php echo $this->Paginator->sort('Orderitem.created',__('time'));?></th>
