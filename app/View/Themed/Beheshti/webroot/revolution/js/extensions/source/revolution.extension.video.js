...
(function ($) {
  ...
  jQuery.extend(true, _R, {
    ...
    isVideoMuted: function (_nc, opt) {
      ...
      switch (_nc.data("videotype")) {
        ...
        case "html5":
          var jvideo = _nc.find("video"),
            video = jvideo[0];
          if (_nc.data("volume") == "mute") video.muted = true;
          break;
      }
      return muted;
    },
    ...
    checkVideoApis: function (_nc, opt, addedApis) {
      ...
      if (
        ...
        f.src =
          httpprefix +
          "://f.vimeocdn.com/js/froogaloop2.min.js"; /* Load Player API*/
        ...
        jQuery("head")
          ...
          .each(function () {
            if (
              ...
              httpprefix + "://a.vimeocdn.com/js/froogaloop2.min.js"
            )
              loadit = false;
          });
      ...
      var vida = _nc.data("videoattributes"),
        ...
        videotype =
          videomp != undefined || videowebm != undefined
            ...
            : "none",
        newvideotype =
          videotype == "html5" && _nc.find("video").length == 0
            ? "html5"
  ...
  var htmlvideoevents = function (_nc, opt, startnow) {
    ...
    addEvent(video, "play", function () {
      ...
      punchgs.TweenLite.to(_nc.find("video"), 0.3, {
        autoAlpha: 1,
        display: "block",
        ease: punchgs.Power3.easeInOut,
      });
