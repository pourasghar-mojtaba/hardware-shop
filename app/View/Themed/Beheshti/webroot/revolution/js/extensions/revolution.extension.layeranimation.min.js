...
!(function (a) {
  ...
  jQuery.extend(!0, t, {
    ...
    animateSingleCaption: function (a, n, r, u, w, y, b) {
      ...
      if (
        (a.data("_pw") ||
          (a.data("_pw", L), a.data("_lw", W), a.data("_mw", C)),
        "fullscreen" == n.sliderLayout &&
          (u = _ / 2 - (n.gridheight[n.curWinRange] * n.bh) / 2),
      ...
      var Q =
        p(a.data("visibility"), n)[n.forcedWinRange] ||
        p(a.data("visibility"), n) ||
        "on";
      if (
        ("off" == Q ||
      ...
      if (
        ...
        a.hasClass("tp-videolayer") ||
          ...
          a.find("video").length > 0)
      ) {
        if (
          (a.data("layertype", "video"),
          t.manageVideoLayer(a, n, y, x),
          !y && !x)
        ) {
          a.data("videotype");
          t.resetVideo(a, n);
        ...
        void 0 != Y &&
          Y.split(":").length > 1 &&
          t.prepareCoveredVideo(Y, n, a);
        var M = a.find("iframe") ? a.find("iframe") : (M = a.find("video")),
          V = a.find("iframe") ? !1 : !0,
          N = a.hasClass("coverscreenvideo");
        M.css({ display: "block" }),
          void 0 == a.data("videowidth") &&
            (a.data("videowidth", M.width()),
            a.data("videoheight", M.height()));
        var Z,
          O =
            p(a.data("videowidth"), n)[n.curWinRange] ||
            p(a.data("videowidth"), n) ||
            "auto",
          H =
            p(a.data("videoheight"), n)[n.curWinRange] ||
            p(a.data("videoheight"), n) ||
            "auto";
        (O = parseFloat(O)),
          (H = parseFloat(H)),
        ...
        if (
          ("auto" == $.lineHeight && ($.lineHeight = $.fontSize + 4),
          a.hasClass("fullscreenvideo") || N)
        ) {
      ...
      if (void 0 === E) {
        var E = new Object();
        (E.voa =
          p(a.data("voffset"), n)[n.curWinRange] || p(a.data("voffset"), n)[0]),
          (E.hoa =
            p(a.data("hoffset"), n)[n.curWinRange] ||
            p(a.data("hoffset"), n)[0]),
      ...
      b ||
        ...
        void 0 == a.data("timeline") ||
          x ||
          (2 != T && a.data("timeline").gotoAndPlay(0), (x = !0)),
        !y &&
          a.data("timeline_out") &&
          2 != T &&
          0 != T &&
      ...
      if (
        ((fa = jQuery.isNumeric(fa) ? fa : 0),
        wa.pause(),
        (1 > fa && 1 != a.data("outstarted")) || 2 == T || b)
      ) {
        var ya = a;
        if (
        ...
        if (!a.data("$anims") || b || Ta) {
          ...
          (Wa = s(Wa, a.data("transform_idle"))),
            ...
            (Wa.anim.ease = La.anim.ease =
              La.anim.ease || punchgs.Power1.easeInOut),
            ja &&
        ...
        if (
          ((xa.f.anim.x =
            xa.f.anim.x * n.bw ||
            d(xa.f.anim.x, n, ta, ia, ma, ga, "horizontal")),
          (xa.f.anim.y =
            xa.f.anim.y * n.bw ||
            d(xa.f.anim.y, n, ta, ia, ma, ga, "vertical")),
          2 != T || b)
        ) {
          if (ya != a) {
            var ka = xa.r.anim.ease;
            wa.add(punchgs.TweenLite.set(a, xa.r.anim)),
              (xa.r = i()),
              (xa.r.anim.ease = ka);
          }
          if (
            ...
            (_a.ease = xa.r.anim.ease),
              ...
              (Ia.anim.x =
                Ia.anim.x * n.bw ||
                d(Ia.anim.x, n, ta, ia, ma, ga, "horizontal")),
              (Ia.anim.y =
                Ia.anim.y * n.bw ||
                d(Ia.anim.y, n, ta, ia, ma, ga, "vertical")),
              wa.add(
            ...
            wa.add(
              punchgs.TweenLite.set(C, { overflow: "visible" }, La.elemdelay),
              0
            );
        }
        a.data("timeline", wa),
          (n.sliderscrope =
            void 0 === n.sliderscrope
          ...
          ("sliderenter" != pa || ("sliderenter" == pa && n.overcontainer)) &&
            (-1 == T ||
              1 == T ||
              b ||
              (0 == T && 1 > fa && a.hasClass("rev-static-visbile"))) &&
            ((1 > fa && fa > 0) ||
      ...
      "on" == a.data("loopanimation") &&
        punchgs.TweenLite.set(W, { minWidth: ta, minHeight: ia }),
        0 == a.data("slidelink") ||
